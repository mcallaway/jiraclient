...
// Enter the information we gathered from LDAP into AD
  ...
  if ($user == $AdUserName) {
    echo "This user already exists in the DSG active directory, so I am not creating it.\n";
  }
  else {
    echo "Adding $user to DSG active directory...";
    $attributes=array(
                "username"=>$user,
                "logon_name"=>$user,
