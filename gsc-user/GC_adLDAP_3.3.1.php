...
class adLDAP {
    ...
    * @var string
    */   
    protected $_account_suffix = "@gc.local";
    ...
    * @var string
    */
    protected $_base_dn = "DC=gc,DC=local"; 
    ...
    * @var array
    */
    protected $_domain_controllers = array ("vm37.gsc.wustl.edu");
    ...
    * @var string
    */
    protected $_ad_username='svc_ldap';
    protected $_ad_password='LKy6#!4sW';
