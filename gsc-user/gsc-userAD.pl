...
my $app = gscuserAD->new($debug,$test);
...
gscuserAD - Add a user to Active Directory based on what exists in LDAP

=head1 SYNOPSIS

gscuserAD [options] username
